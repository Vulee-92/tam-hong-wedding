...
export const weddingData = {
  ...
  bibleVerse: {
    quote: '"Nếu Đức Chúa Trời yêu thương chúng ta như thế, chúng ta cũng phải yêu thương nhau."',
    reference: "(1 Giăng 4:11)",
  },
  // Thông tin Chú rể
  groom: {
    name: "Trần Hữu Tâm",
    ...
    nameOnly: "Tâm",
    role: "Út Nam ",
    father: "TRẦN HỮU TRUNG",
    mother: "THÂN THỊ MINH",
  },
  weddingDateDetails: {
    year: 2025,
    month: 10, // Tháng 10
  ...
  partyTime: "Tiệc thân mật được tổ chức vào lúc 16 giờ 00 phút",
  weddingDate: "12-10-2025",
  weddingFullYear: 2025,
  lunarCalendar: " Nhằm ngày 20 tháng 8 năm Ất Tỵ",
  day: "THỨ 7",
  time: "16-00",
  weddingMothName: "Tháng 10",
  // Thông tin Cô dâu
  bride: {
    ...
    nameOnly: "Hồng",
    role: "Út nữ",
    father: "NGUYỄN VĂN CHỜ",
    mother: "HÀ THỊ HOÀN",
  },
   GOOGLE_SHEETS_RSVP: "https://script.google.com/macros/s/AKfycbxTgMMT2u_dlwiUiI_BKI-63gEdQfwVcFBbBlaYFlxL7fD61Y8xio8NGueKUJKg_j5n/exec", // Thay thế bằng URL thực tế của bạn
   GOOGLE_SHEETS_LINK: "https://script.google.com/macros/s/AKfycbzOtdeL8tYi4C0bUsoVy9ZFfEkH7Y44yRsVlinwsRVCnEZc_cg7Q7EsrD-XdV6x1bdI/exec", // Thay thế bằng URL thực tế của bạn

  // Thông báo chính của thiệp
  invitationNote: "Trân trọng kính mời",
  titleletter: "LỄ THÀNH HÔN CỦA CON CHÚNG TÔI",
  title2: "Tiệc Tân Hôn",
  ...
  events: [
    {
      ...
      name: "Tiệc tân hôn",
      date: "11-10-2025",
      lunarCalendar: " Nhằm ngày 15 tháng 08 năm Ất Tỵ",
      day: "THỨ 7",
      time: "16:00",
      restauracnceName: "Tư Gia Nhà Trai",
      location:
        "Thôn Chùa - Xã Hiệp Hoà - Tỉnh Bắc Ninh",
    },
  ],
  ...
  bankbride: 
    {
       owner: "NGUYEN THI HONG",
      bank: "TECHCOMBANK", // Sửa lại tên ngân hàng để dễ đọc
      bankCode: "MB", // Thêm mã ngân hàng
      account: "19037090463014",
      role: "bride",
    },
  ...
  // Lời cảm ơn
  thankYouNote: "Chúng tôi chân thành cảm ơn sự hiện diện và lời chúc phúc của quý vị.\nNguyện xin Chúa ban ơn và niềm vui dư dật trên mỗi người.",
  map: "https://maps.app.goo.gl/WhCytGA14rPoXhf5A",
  // Các đường link ảnh
  images: {
    mobilePhoto:
      "https://res.cloudinary.com/dq0fochj2/image/upload/v1759212506/h29_iaqvdn.jpg",
    desktopPhoto:
      "https://res.cloudinary.com/dq0fochj2/image/upload/v1759212506/h29_iaqvdn.jpg",
  albumPhotos: [
